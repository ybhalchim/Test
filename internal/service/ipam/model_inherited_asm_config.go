...
func ExpandInheritedASMConfig(ctx context.Context, o types.Object, diags *diag.Diagnostics) *ipam.InheritedASMConfig {
...
func (m *InheritedASMConfigModel) Expand(ctx context.Context, diags *diag.Diagnostics) *ipam.InheritedASMConfig {
	if m == nil {
		return nil
	}
...
func FlattenInheritedASMConfig(ctx context.Context, from *ipam.InheritedASMConfig, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *InheritedASMConfigModel) Flatten(ctx context.Context, from *ipam.InheritedASMConfig, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
