...
var NameserverResourceSchemaAttributes = map[string]schema.Attribute{
...
func ExpandNameserver(ctx context.Context, o types.Object, diags *diag.Diagnostics) *ipam.Nameserver {
	if o.IsNull() || o.IsUnknown() {
		return nil
	}
	var m NameserverModel
...
func (m *NameserverModel) Expand(ctx context.Context, diags *diag.Diagnostics) *ipam.Nameserver {
	if m == nil {
		return nil
	}
	to := &ipam.Nameserver{
...
func FlattenNameserver(ctx context.Context, from *ipam.Nameserver, diags *diag.Diagnostics) types.Object {
	if from == nil {
		return types.ObjectNull(NameserverAttrTypes)
	}
	m := NameserverModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, NameserverAttrTypes, m)
	diags.Append(d...)
	return t
}

func (m *NameserverModel) Flatten(ctx context.Context, from *ipam.Nameserver, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
